...
public enum KeychainStatus: OSStatus, Error, Sendable {
    case success                            = 0
...
extension KeychainStatus: RawRepresentable, CustomStringConvertible {
    public init(status: OSStatus) {
        self = KeychainStatus(rawValue: status) ?? .unexpectedError
    }
